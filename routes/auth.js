...
//       `INSERT INTO users (username, first_name, last_name, country, password, email, prof_pic) VALUES ('${user_details.username}', '${user_details.firstname}', '${user_details.lastname}',
